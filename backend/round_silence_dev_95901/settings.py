"""
Django settings for round_silence_dev_95901 project.
...
ROOT_URLCONF = 'round_silence_dev_95901.urls'
...
WSGI_APPLICATION = 'round_silence_dev_95901.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_silence_dev_95901 API",
    "DESCRIPTION": "API documentation for round_silence_dev_95901 App",
    "VERSION": "v1",
}
